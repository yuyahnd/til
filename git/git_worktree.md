...
|\<worktree>|ワークツリーは、相対パスまたは絶対パスのいずれかで識別できます。<br><br>ワークツリーのパスの最後のパス コンポーネントがワークツリー間で一意である場合、それを使用してワークツリーを識別することができます。 たとえば、/abc/def/ghi と /abc/def/ggg に 2 つのワークツリーしかない場合、ghi または def/ghi で前のワークツリーを指すのに十分です。|
